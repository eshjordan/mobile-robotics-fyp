...
public:
    ...
    std::shared_ptr<ConcreteBaseRobotCommsModel> model;
};

TEST_F(TestBaseRobotCommsModel, TestConstructor)
{
...
TEST_F(TestBaseRobotCommsModel, TestGetKnownIds)
{
