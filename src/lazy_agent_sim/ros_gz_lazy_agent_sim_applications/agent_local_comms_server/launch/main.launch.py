    ...
    'agents': [
        {
            ...
            'robot_command_host': '192.168.11.12',
            'robot_command_port': 1001,
        ...
        },
        {
            ...
            'robot_epuck_port': 1000,
            'robot_command_host': '192.168.11.11',
            'robot_command_port': 1001,
        ...
        },
        {
            ...
            'robot_epuck_port': 1000,
            'robot_command_host': '192.168.11.13',
            'robot_command_port': 1001,
        ...
        },
        {
            ...
            'robot_epuck_port': 1000,
            'robot_command_host': '192.168.11.14',
            'robot_command_port': 1001,
        ...
        #     'robot_epuck_port': 1000,
        #     'robot_command_host': '192.168.11.15',
        #     'robot_command_port': 1001,
        ...
        _include = IncludeLaunch(
            ...
            launch_arguments={
                ...
                'manager_server_port':
                    f"{launch_configuration['manager_server_port']}",
                'robot_command_host':
                    f"{agent['robot_command_host']}",
                'robot_command_port':
                    f"{agent['robot_command_port']}",
